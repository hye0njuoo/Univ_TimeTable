...
class UnivTimeTableController: UIViewController {
    weak var elliotable: UnivTimeTable!
    weak var collectionView: UICollectionView! {
        didSet {
            collectionView.isScrollEnabled = true
            collectionView.register(LectureCell.self, forCellWithReuseIdentifier: reuseIdentifier)
        }
    }
}

extension UnivTimeTableController: UICollectionViewDataSource {
    ...
    internal func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell           = collectionView.dequeueReusableCell(withReuseIdentifier: reuseIdentifier, for: indexPath) as! LectureCell
...
extension UnivTimeTableController: UICollectionViewDelegateFlowLayout {
